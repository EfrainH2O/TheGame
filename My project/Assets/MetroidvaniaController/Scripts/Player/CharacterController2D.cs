...
public class CharacterController2D : MonoBehaviour
{
	...
	public void ApplyDamage(Vector3 position) 
	{
		if (!invincible)
		{
			...
			life -= 1;
			Vector2 damageDir = Vector3.Normalize(transform.position - position) * 50f ;
    ...
    public void PseudoDeath()
	{
        StartCoroutine(WaitToPseudoDead());
    }
